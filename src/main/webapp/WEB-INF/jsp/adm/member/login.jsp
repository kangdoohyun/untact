	...
	<section class="section-login">
		<div class="container mx-auto min-h-screen flex items-center justify-center">
			<div class="w-full">
				...
				<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 flex flex-col mt-4" action="doLogin" method="POST" onsubmit="LoginForm__checkAndSubmit(this); return false;">
					<div class="flex flex-col mb-4 md:flex-row">
						<div class="p-1 md:w-36 md:items-center">
							<span>로그인 ID</span>
						</div>
					...
					<div class="flex flex-col mb-4 md:flex-row">
						...
						<div class="p-1 md:flex-grow">
							<input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" type="password"
